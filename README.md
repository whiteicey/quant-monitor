...
**求交易策略大佬指点！** 我就一写代码的，对交易策略的理解还停留在金叉死叉的水平QAQ 目前这些策略都是很基础的技术分析，如果有大佬懂更高级的策略思路（比如量价关系、市场微观结构、因子分析之类的），求求教教我，或者直接提 issue/PR 也行，感激不尽！

**求学习机会！** 如果有大佬以这个项目为基础魔改出了更厉害的版本，拜托拜托一定让我知道让我去学习QAQ 可以直接开 issue 或者 fork 后 @ 我，我一定认真学习！
